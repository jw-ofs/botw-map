...
![categories](https://img.shields.io/badge/markers-2689-5ad1e6) shrines · towers · koroks · treasure · enemies · places · memories route
...
- **2,689 datamined markers** across 18 categories (see below), pixel-accurate to the map.
...
- **Treasure chests** (1,165) with itemized contents and a Rupees/Gems/Arrows/Gear/Other
  sub-filter, plus a dedicated **Armor** category (53 — 32 chest pieces + 21 buyable/earnable
...
| Treasure | Treasure Chests (1,165 — content filter: Rupees / Gems / Arrows / Gear / Other), Armor (53 — chest pieces + buyable/earnable sets, with set bonus / slot / defense / source) |
